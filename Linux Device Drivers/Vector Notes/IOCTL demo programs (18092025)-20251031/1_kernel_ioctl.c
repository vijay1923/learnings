...
//#define GPIO_17_SET _IOW('g', '1', int*)
//#define GPIO_17_CLR _IOW('g', '0', int*)

//#define WR_VAL1 _IOW('a', 'b', int*)
//#define WR_VAL2 _IOW('a', 'c', int*)
//#define WR_VAL3 _IOW('a', 'd', int*)
...
long my_ioctl (struct file *f, unsigned int cmd, unsigned long arg){
	...
	switch(cmd){
		case WR_VAL: printk("ioctl WR_VAL command\n");	
			     break;
